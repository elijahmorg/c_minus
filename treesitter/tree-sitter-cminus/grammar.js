...
module.exports = grammar({
  ...
  conflicts: $ => [
    ...
    [$.module_qualified_identifier, $.qualified_type],
  ],
  ...
  rules: {
    ...
    cminus_function_definition: $ => seq(
      optional($.pub_modifier),
      'func',
      field('name', $.identifier),
      field('parameters', $.cminus_parameter_list),
      field('return_type', $.type_specifier),
      field('body', $.compound_statement),
    ),

    cminus_parameter_list: $ => seq(
      '(',
      commaSep($.cminus_parameter_declaration),
      ')',
    ),

    cminus_parameter_declaration: $ => seq(
      field('name', $.identifier),
    ...
    module_qualified_call: $ => prec(PREC.CALL, seq(
      field('function', $.module_qualified_identifier),
      field('arguments', $.argument_list),
    )),
    ...
    module_qualified_identifier: $ => seq(
      field('module', $.module_identifier),
      '.',
      field('name', $.identifier),
    ),

    module_qualified_enum: $ => prec(PREC.FIELD + 1, seq(
      field('module', $.module_identifier),
      '.',
    ...
    qualified_type: $ => prec.dynamic(1, seq(
      field('module', $.module_identifier),
      '.',
      field('name', $._type_identifier),
    )),
